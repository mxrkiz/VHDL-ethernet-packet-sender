...
![Schematic](images/ethernet_diagram.png "Block Diagram"){width=85%}
...
- **PHY**: SMSC LAN8720A (onboard, RMII, address `0x01`)
- **IDE**: AMD Vivado Design Suite 2025.2

![Schematic](images/Schemata.png "Top-level schematic"){width=85%}
...
Constraints live in `Ethernet.srcs/constrs_1/nexys.xdc`. See _Figure 3_
below for the PHY pinout reference from the board manual.
...
3. 3. *Run Synthesis → Run Implementation → Generate Bitstream → Program Device*.
...
![tb_crc8 waveform](images/tb_crc8.png "tb_crc8 waveform"){width=85%}
...
![tb_fifo waveform](images/tb_fifo.png "tb_fifo waveform"){width=85%}
...
![tb_packet_builder waveform](images/tb_packet_builder.png "tb_packet_builder waveform"){width=85%}
...
![tb_tx_fsm waveform](images/tb_tx_fsm.png "tb_tx_fsm waveform"){width=85%}
...
![tb_rx_fsm waveform](images/tb_rx_fsm.png "tb_rx_fsm waveform"){width=85%}
...
![PHY Pinout on Nexys A7 board](images/ArtyxPHYPinout.png "PHY Pinout"){width=55%}
...
- **Ondřej Polášek** :computer: :goat: — Project Lead
- **Ladislav Šilhán** :frame_photo: — Designer
- **Maxim Sudakov** :wrench: — Developer
- **Alexandr Stoljar** :wrench: — Developer

## References

1. [Tomas Fryza GitHub](https://github.com/tomas-fryza/vhdl-examples/)
2. [Manual Nexys A7™](https://digilent.com/reference/_media/reference/programmable-logic/nexys-a7/nexys-a7_rm.pdf)
3. [Ethernet Frame](https://en.wikipedia.org/wiki/Ethernet_frame)
4. [Media-Independent Interface](https://en.wikipedia.org/wiki/Media-independent_interface)
5. [LAN8720A datasheet (Microchip)](https://ww1.microchip.com/downloads/en/DeviceDoc/8720a.pdf)
6. [RMII Specification, rev 1.2 (RMII Consortium)](https://web.archive.org/web/20160805174014/http://ebook.pldworld.com/_eBook/-Telecommunications,Networks-/TELECOM/RMII/rmii_rev12.pdf)
7. [IEEE 802.3-2018 — Eth